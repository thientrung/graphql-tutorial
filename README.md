...
###### Tóm lại GraphQL bao gồm 2 phần chính:
 ...
 > Nếu tại đây bạn vẫn thắc mắc concept này có không có gì khác biệt so với RESTful thì có thể xem lại [so sánh giữa RESTful và GraphQL ở đây](https://github.com/vitalifyjp/vfa-workshop-graphql-apollo/blob/lession1/courses/DAY1.md#sosanh).
----
...
Trước khi bắt đầu thực hành, xin nhắc lại cấu trúc thư mục được chia làm 2 phần `bai-tap` và `tham-khao` ([chi tiết xem tại đây](https://github.com/vitalifyjp/vfa-workshop-graphql-apollo/blob/lession1/README.md#3-th%E1%BB%B1c-h%C3%A0nh-%C4%91%C6%B0%E1%BB%A3c-hello-world))
