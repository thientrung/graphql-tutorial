...
Trước khi bắt đầu thực hành **Mutation**, xin nhắc lại là ở [bài 2 Query](https://github.com/thientrung/graphql-tutorial/tree/lesson2#resolver) lần trước chúng ta đã dùng dữ liệu giả cố định để trả về.
